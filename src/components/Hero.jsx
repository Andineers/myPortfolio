  ...
  return (
    <div className='grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-full md:h-[70vh] mx-auto py-8 bg-black'>
      ...
      <div className='col-span-2 px-5'>
        <h1 className='text-white text-2xl sm:text-xl mt-[100px] lg:text-8xl font-extrabold'>
        ...
        <div className='my-8'>
          <a href="/" className='px-6 py-3 w-full rounded-xl mr-4 bg-gradient-to-br from-pink-500 to-blue-300 text-white'>Download CV</a>
          <a href="#contact" className='px-6 py-3 w-full rounded-xl  border border-gray-400 hover:bg-gradient-to-br from-pink-500 to-blue-300 text-white hover:border-none'>Contact</a>
        </div>
