...
const Skills = () => {
  return (
    <div className="border border-gray-600 bg-black text-gray-400 md:h-[150px] max-w-full mx-auto grid grid-cols-6 place-items-center md:flex md:justify-between md:items-center">
